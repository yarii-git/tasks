...
<div class="row">
    <div class="col-12">
        <div>
            <h2 class="text-white">CRUD de Tareas by Yarií</h2>
        </div>
        <div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{route('tasks.destroy', $task)}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" onclick="return confirm('¿Realmente quieres eliminar la tarea?')">Eliminar</button>
                        </form>
                    </td>
                </tr>
            @endforeach
