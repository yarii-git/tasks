            ...
            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <select name="status" class="form-select" id="">
                        ...
                        <option value="To do" @selected("To do" == $task->status)>Pendiente</option>
                        <option value="Doing" @selected("Doing" == $task->status)>En progreso</option>
                        <option value="Done" @selected("Done" == $task->status)>Completada</option>
                    </select>
                </div>
            </div>
